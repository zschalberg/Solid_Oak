...
#define B_FLAG_FOLLOWERS_DISABLED      0x0C0      // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_TRIPLE_LAYER_METATILES       TRUE          // If TRUE, metatiles store 12 tiles (3 real bg layers) instead of 8. Requires migrating all data/tilesets/*/metatiles.bin files first - see tools/migrate_triple_layer_metatiles.py and porymap.project.cfg's enable_triple_layer_metatiles setting.
