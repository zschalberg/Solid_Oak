...
extern const struct SpritePalette gSpritePalette_GeneralFieldEffect1Haunted;
...
extern const struct SpriteTemplate gFieldEffectObjectTemplate_TallGrassHaunted;
