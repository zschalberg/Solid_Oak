...
enum StringID
{
    ...
    STRINGID_STARTEDELECTRICFLOOR,
    STRINGID_STARTEDPOISONFOG,
    STRINGID_WEATHERENDEDELECTRICFLOOR,
    STRINGID_WEATHERENDEDPOISONFOG,
    STRINGID_WEATHERTURNELECTRICFLOOR,
    STRINGID_WEATHERTURNPOISONFOG,
    ...
    STRINGID_ELECTRICFLOORSTART,
    STRINGID_POISONFOGSTART,
    ...
    STRINGID_ELECTRICFLOORHEALS,
    STRINGID_ELECTRICFLOORHURTS,
    STRINGID_POISONFOGPOISONS,
    ...
    STRINGID_HANDLENEWORPARTYMON,
    STRINGID_RELEASETOMAKEROOM,
    STRINGID_TRANSFERORRELEASE,
    STRINGID_PKMNRELEASEDFORCOINS,
    STRINGID_PKMNBROKEFREEFORGOOD,
    ...
    STRINGID_PROTOBALL_FAILED,
    STRINGID_UNCOMMON_SIZE_CAUGHT,
    STRINGID_RARE_SIZE_CAUGHT,
    STRINGID_VERY_RARE_SIZE_CAUGHT,
    STRINGID_BERRY_CATCH_BOOST_RAZZ,
    STRINGID_BERRY_CATCH_BOOST_NANAB,
    STRINGID_BERRY_CATCH_EXPIRED,
    STRINGID_IVSCANNER_USE_AND_SCAN,
    STRINGID_IVSCANNER_RATING,
    STRINGID_TURNSREMAINING,
    STRINGID_OUTOFTURNS,

    STRINGID_PKMNCANTUSEMOVEBATTLERULE,

    STRINGID_PKMNISEVOLVING,
    STRINGID_PKMNEVOLVEDINTO,
    STRINGID_PKMNSTOPPEDEVOLVING,
    STRINGID_HUH,
...
enum MoveWeatherChangeStringID
{
    ...
    B_MSG_STARTED_SNOW,
    B_MSG_STARTED_FOG,
    B_MSG_STARTED_ELECTRIC_FLOOR,
    B_MSG_STARTED_POISON_FOG,
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_ELECTRIC_FLOOR,
    B_MSG_WEATHER_END_POISON_FOG,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_ELECTRIC_FLOOR,
    B_MSG_WEATHER_TURN_POISON_FOG,
};
