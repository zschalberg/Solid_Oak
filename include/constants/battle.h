...
#define BATTLE_TYPE_PREVIEW            (1 << 30)
...
#define B_WEATHER_ELECTRIC_FLOOR (1 << BATTLE_WEATHER_ELECTRIC_FLOOR)
#define B_WEATHER_POISON_FOG     (1 << BATTLE_WEATHER_POISON_FOG)

#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_ELECTRIC_FLOOR)
...
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG | B_WEATHER_ELECTRIC_FLOOR | B_WEATHER_POISON_FOG)
