...
#define FLAG_DOJO_VERMILION_WHITE_BELT   0x20C
#define FLAG_DOJO_VERMILION_BLUE_BELT    0x20D
#define FLAG_DOJO_VERMILION_BLACK_BELT   0x20E
#define FLAG_TUTOR_POWER_UP_PUNCH        0x20F
#define FLAG_TUTOR_AERIAL_ACE            0x210
#define FLAG_TUTOR_BRICK_BREAK           0x211
#define FLAG_TUTOR_CLOSE_COMBAT          0x212
