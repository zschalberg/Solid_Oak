...
enum ObjectEventGfx
{
    ...
    OBJ_EVENT_GFX_TENTACRUEL_SWIMMING_XL,
    OBJ_EVENT_GFX_CONSTRUCTION_WORKER,
    OBJ_EVENT_GFX_PC_PROF_OAK_SURF,
    OBJ_EVENT_GFX_PAMTRE_APRICORN_TREE,
...
#define OBJ_EVENT_PAL_TAG_AGATHA                  0x116D
#define OBJ_EVENT_PAL_TAG_CONSTRUCTION_WORKER     0x116E
