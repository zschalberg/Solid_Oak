...
extern const u8 gOakSpeech_Text_Introduction[];
extern const u8 gOakSpeech_Text_LookAtThis[];
extern const u8 gOakSpeech_Text_DescribeIntroMon[];
extern const u8 gOakSpeech_Text_Migration[];
extern const u8 gOakSpeech_Text_Assignment[];
extern const u8 gOakSpeech_Text_SendOff[];
...
extern const u8 gText_PkmnSentToFujiAfterCatch[];
