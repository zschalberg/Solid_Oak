...
**Always build via WSL (Ubuntu/Debian)**. The project builds 2x faster than msys2 and 5–6x faster than Cygwin. After making changes, verify the build succeeds before declaring work done.
