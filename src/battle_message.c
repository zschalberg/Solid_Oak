...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_TURNSREMAINING]                      = COMPOUND_STRING("{B_BUFF1} turns remaining in this battle!"),
    [STRINGID_OUTOFTURNS]                          = COMPOUND_STRING("You ran out of turns!\p"),
    ...
    [STRINGID_HANDLENEWORPARTYMON]                  = COMPOUND_STRING("Make room for {B_DEF_NAME}?\n(No: release or transfer)"),
    [STRINGID_RELEASETOMAKEROOM]                    = COMPOUND_STRING("Release a Pokémon to keep it?\n(No: release {B_DEF_NAME} instead)"),
